...
//import { AwfButton } from '@agilent/awf-wc/button';
//import { AwfInputText } from '@agilent/awf-wc/input-text';
//import { AwfTitleBar } from '@agilent/awf-wc/title-bar';
//import { AwfInputPassword } from '@agilent/awf-wc/input-password';
//import { AwfBanner } from '@agilent/awf-wc/banner';
...
import { LoginPageComponent } from '@agilent/ui-template/login-page';
import { CredentialSuccessFormComponent } from '@agilent/ui-template/credential-form'; 

import { RunForm, RunPanelComponent } from '../run-panel/run-panel';
import { Instrument, InstrumentListComponent } from '../instrument-list/instrument-list';
...
@Component({
  ...
  imports: [CommonModule, RunPanelComponent, InstrumentListComponent, ProjectListComponent, StatusComponent, LoginPageComponent, CredentialSuccessFormComponent],
...
export class TestApi {
  ...
  changePasswordAction(event: any): void {
    ...
    this.message.push('Change password requested.');
  }

  closeAction(event: any): void {
    console.log('closeAction', event);
    this.message.push('Login dialog closed.');
  }
  ...
  loginAction(event: any): void {
    ...
    const incomingDomain = event?.domain ?? this.domain;
    this.username = incomingUsername;
    this.password = incomingPassword;
    this.domain = incomingDomain;
  ...
  start(): void {
    ...
    this.authService.login(this.username, this.password, this.domain).subscribe({
